...
-Мухтар внимательно смотрит на тебя, а затем толкает механизированной мордой в ногу, чтобы ты обратил на него внимание. #Speaker.Storyteller
    ...
    * [Изучить капсулу бы...] #Speaker.Tisha
        -> scene_3_2_block_3_1
    * [Отличное первое дежурство. Просто, мать его, отличное.] #Speaker.Tisha //Что здесь должно быть ----- ??? -----
        ->CorrectCompletion
...
-Кажется, отсюда нужно уматывать. #Speaker.Tisha
    +[>>]
-Ты берешь девочку на руки и делаешь несколько шагов назад. Дым из капсулы начинает валить еще сильнее. Ты делаешь еще несколько шагов. БАБАХ! Взрывная волна заставляет тебя упасть, но ты вовремя успел отойти назад. #Speaker.Storyteller #Quest.SaveAndPreserve
    +[>>]
->CorrectCompletion
