...
public class MoveToDogTask : BaseQuestTask
{
    ...
    public override void Activate()
    {
        ...
        Debug.Log($"MoveToDogTask.Activate: {_name}");
    ...
    {
        Debug.Log($"MoveToDogTask.Complete: {_name}");
    ...
    {
        Debug.Log($"MoveToDogTask.Dectivate: {_name}");
